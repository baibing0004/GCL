...
using GCL.Db.Ni.RedisDB;
using GCL.Db.Ni.NoSQL;

namespace GCL.Db.Ni {
    public class RedisDbFactory : IDataAbstractFactory {
        public RedisDbFactory(ISqlParser parser) {
            this.parser = parser;
        }
        ...
        public IDbDataAdapter CreateAdapter() {
            return new RedisDbAdapter();
        }

        public IDbCommand CreateCommand() {
            if (this.parser != null)
                return new RedisDbCommand(this.parser);
