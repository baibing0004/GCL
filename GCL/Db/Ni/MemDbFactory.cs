...
using GCL.Db.Ni.MemcacheDB;
using GCL.Db.Ni.NoSQL;

namespace GCL.Db.Ni {
    public class MemDbFactory : IDataAbstractFactory {
        public MemDbFactory(ISqlParser parser) {
            this.parser = parser;
        }
        ...
        public IDbConnection CreateConnection() {
            return new MemDbConnection();
        }

        public IDbDataAdapter CreateAdapter() {
            return new MemDbAdapter();
        }

        public IDbCommand CreateCommand() {
            if (this.parser != null)
                return new MemDbCommand(this.parser);
