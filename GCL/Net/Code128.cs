...
namespace GCL.Net {
    ...
    /// zgke@sina.com
    /// qq:116149
    /// GCL.Net.Code128 _Code = new GCL.Net.Code128();
    ///_Code.ValueFont = new Font("宋体", 10);
    ///pictureBox1.Image=_Code.GetCodeImage("20081011001010020001", GCL.Net.Code128.Encode.Code128B);
    ...
    public class Code128 {
        ...
        private void GetViewText(Bitmap p_Bitmap, string p_ViewText) {
            ...
            if (_DrawSize.Height > p_Bitmap.Height - 20 || _DrawSize.Width > p_Bitmap.Width) {
                _Graphics.Dispose();
                return;
            }
