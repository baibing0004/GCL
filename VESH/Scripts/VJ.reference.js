...
//讲第二个数组里面的内容发到第一个数组里面
VJ.concat = function(arr1,arr2){
	if(typeof(arr1) == 'undefined'){return arr2;}
	while(arr2.length>0){
...
VJ.getClipBoardText = function(e){
...
VJ.newFrag = function(){return document.createDocumentFragment();}
//TODO Object Enable Event
